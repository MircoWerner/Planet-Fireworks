...
public final class Transformation {
    ...
    public static Matrix4f getTransformationMatrix(Text text) {
        Matrix4f transformationMatrix = new Matrix4f();
        transformationMatrix.identity().translate(text.getPosition().x, text.getPosition().y, 0).
                scale(text.getScale().x, text.getScale().y, 0);
        return transformationMatrix;
    }
